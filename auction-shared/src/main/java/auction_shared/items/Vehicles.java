...
public class Vehicles extends Item {
    public Vehicles(String id, String itemName, String description, double startingPrice, double buyOutPrice, double productTickRate, LocalDateTime endTime, User owner) {
