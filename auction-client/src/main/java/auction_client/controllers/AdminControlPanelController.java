...
public class AdminControlPanelController implements Initializable, AuctionUpdateListener {
    ...
    @FXML
    TableColumn<UserDTO,Void> colUserAction; //button
    ...
    @FXML
    TableColumn<AuctionDTO,Void> colItemAction; //button

    @Override
    public void initialize(URL location, ResourceBundle resources) {
        // set up tables nha ae
        setupUserTable();
        setupItemTable();
        // request data nha ae
    ...
    public void onUpdateReceived(NetworkMessage msg) {
        ...
        if (action.equals("GET_USERS")) {
            ...
            itemTable.getItems().addAll(auctions);
        }
